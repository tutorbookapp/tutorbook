...
import zoom from 'locales/en/zoom.json';

function ZoomSettingsPage(): JSX.Element {
    ...
    <>
      ...
      {!!org && (
        <Page>
          ...
          />
          <Settings active='zoom' orgId={query.org as string}>
            <Zoom />
          </Settings>
        </Page>
      )}
...
export default withI18n(ZoomSettingsPage, { common, settings, org, zoom });

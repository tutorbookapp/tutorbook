...
export default function Inputs({
  ...
  useEffect(() => setLoading(submitting || submitted), [submitting, submitted]);
  useEffect(() => {
    ...
    <form className={styles.form} onSubmit={onSubmit}>
      ...
      {aspect === 'tutoring' && times && (
        <TimesSelect
          ...
          options={Availability.fromJSON(user.availability)}
          value={times}
        />
      )}
      <TextField
      ...
      />
      {!!error && (
        <TextFieldHelperText persistent validationMsg className={styles.error}>
          {error}
        </TextFieldHelperText>
      )}
    </form>
